...
const Transactions = () => {
  ...
  return (
    <div className=' flex w-full justify-center items-center 2xl:px-20 bg-[#301934]'>
      <div className=' flex flex-col md:p-12 py-12 px-4'>
      {currentAccount ? (
        <h3 className='text-white text-3xl text-center my-2'>Latest Transactions</h3>
      ) : (
        <h3 className='text-white text-3xl text-center my-2'>Connect Account to see transactions</h3>
      )}
